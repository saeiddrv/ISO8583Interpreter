...
import ir.saeiddrv.iso8583.message.interpreters.BCDMessageLengthInterpreter;
    ...
    public static void main(String[] args) {
        try {
            ...
            ISOMessageBuilder builder = ISOMessageBuilder.create()
                    ...
                    .setMessageLengthInterpreter(2, new BCDMessageLengthInterpreter())
            ...
            builder.defineField(41,
                    BCD.create(LengthType.FIXED, 8, ContentType.CHARACTER, ContentPad.LEFT_0)
                            .setDescription("Card Acceptor Terminal Identification"));

            builder.defineField(42,
                    BCD.create(LengthType.FIXED, 15, ContentType.CHARACTER, ContentPad.LEFT_0)
                            .setDescription("Card Acceptor Identification Code"));

            builder.defineField(48,
                    BCD.create(LengthType.LLL, 999, ContentType.CHARACTER, ContentPad.RIGHT_0)
            ...
            message.setValue(2, "6219861026599413");
            ...
            message.setValue(35, "6219861026599413=04071111234000001230");
