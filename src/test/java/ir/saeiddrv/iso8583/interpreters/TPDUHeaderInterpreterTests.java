...
//        return new TPDUHeaderInterpreter(TPDU.fromBytes(protocolID, sourceAddress, destinationAddress));
//    }
//
...
//        return new TPDUHeaderInterpreter(TPDU.fromInteger(protocolID, sourceAddress, destinationAddress));
//    }
//
...
//        return new TPDUHeaderInterpreter(TPDU.fromHexString(protocolID, sourceAddress, destinationAddress));
//    }
//
...
//        String sourceAddress = "121";       // hex: 0x0121, Decimal: 289
//        String destinationAddress = "121";  // hex: 0x0121, Decimal: 289
//        return new TPDUHeaderInterpreter(TPDU.fromDecimal(protocolID, sourceAddress, destinationAddress));
//    }
//
//    @Test
//    @DisplayName("CREATING OBJECT: fromBytes")
//    public void assertEqualCreateFromBytes() {
//        byte[] actual = fromBytes().getValue(charset);
...
//                () -> new TPDUHeaderInterpreter(TPDU.fromBytes(aByte, nullValue, address)));
//        assertThrows(IllegalArgumentException.class,
//                () -> new TPDUHeaderInterpreter(TPDU.fromBytes(aByte, new byte[0], address)));
//        assertThrows(IllegalArgumentException.class,
//                () -> new TPDUHeaderInterpreter(TPDU.fromBytes(aByte, new byte[3], address)));
//        assertThrows(NullPointerException.class,
//                () -> new TPDUHeaderInterpreter(TPDU.fromBytes(aByte, address, nullValue)));
//        assertThrows(IllegalArgumentException.class,
//                () -> new TPDUHeaderInterpreter(TPDU.fromBytes(aByte, address, new byte[0])));
//        assertThrows(IllegalArgumentException.class,
//                () -> new TPDUHeaderInterpreter(TPDU.fromBytes(aByte, address, new byte[3])));
//    }
}
